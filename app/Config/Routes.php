...
$routes->setDefaultController('page/login');
...
$routes->match(['get', 'post'], '/user/cs', 'Page::cs');
$routes->match(['get', 'post'], '/user/dsn', 'Page::dsn');
$routes->match(['get', 'post'], '/user/kontak', 'Page::kontak');
$routes->match(['get', 'post'], '/user/bisnis', 'Page::bisnis');
$routes->match(['get', 'post'], '/user/computerscience', 'Page::computerscience');
$routes->match(['get', 'post'], '/user/desain', 'Page::desain');
